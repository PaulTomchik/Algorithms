...
public class GroovyMergeSorterTest {

    @Test
    public void testNullArraySort() throws Exception {
        new GroovyMergeSorter().sort(null, null);
    }

    @Test
    public void testEmptyArraySort() throws Exception {
        new GroovyMergeSorter().sort(new ArrayList<>(Arrays.asList(new Integer[]{})), null);
    }
    ...
    public void testIntegerSort() throws Exception {
        ...
        MergeSorter mergeSorter = new GroovyMergeSorter();
